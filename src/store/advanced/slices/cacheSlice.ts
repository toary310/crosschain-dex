...
> = (set, get) => ({
  ...
  setQueryData: (key: string, data: any, ttl = 300000) => // 5 minutes default TTL
    set((state: Store) => {
...
export const setupCacheCleanup = (getStore: () => Store) => {
